...
const ImageCard = ({ image }) => {
  ...
  return (
    <div className="relative overflow-hidden rounded-2xl bg-black transform border-2 border-yellow-200 transition-all duration-300 hover:scale-[1.03] hover:shadow-lg hover:shadow-yellow-400/40">
  <img
    src={image.url}
  ...
  <div className="absolute bottom-0 left-0 right-0 p-2 bg-gradient-to-t from-black via-black/70 to-transparent">
    <div className="text-xs font-medium text-yellow-200 truncate">
