...
const DesignCard = ({ image }) => (
  <div className="group relative border-5 border-white overflow-hidden rounded-xl shadow-2xl shadow-black/70 h-64 w-80 md:w-96 flex-shrink-0 cursor-pointer transition-transform duration-500 hover:scale-[1.03]">
    <img 
      src={image.url} 
    //   alt={image.title} 
    ...
    <div className="absolute top-3 right-3  bg-white/10 backdrop-blur-sm px-3 py-1 rounded-full text-xs font-semibold text-gray-100 uppercase border-4 border-white ">
      {image.category}
    </div>
  </div>
);
              ...
              <div className="space-y-4">
                <div className="flex items-start">
                  ...
                  <div className="ml-4">
                    ...
                    <a href="mailto:contact@amitinteriors.com" className="text-gray-300 hover:text-amber-400 transition">amit78kumag@gmail.com </a>
                  </div>
                </div>
                <div className="flex items-start">
                  ...
                  <div className="ml-4">
                    ...
                    <a href="tel:+919876543210" className="text-gray-300 hover:text-amber-400 transition">+91 9878808321</a>
                  </div>
                </div>
                <div className="flex items-start">
                  ...
                  <div className="ml-4">
                    ...
                    <p className="text-gray-300"> h.no.1337,St.no.8,kara bara, Arjun nagar,near primary school,ludhiana.</p>
                  </div>
                </div>
              </div>
            </div>
